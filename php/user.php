...
if ($UTable_Query) {
    $DOB = date("Y/m/d");
    $User_FIRST_INSERT = "INSERT INTO USER (`F_NAME`,`L_NAME`,`USERNAME`,`PASSWORD`,`PIN_CODE`,`DOB`,`CONTACT`,`PROVINCE`,`CITY`,`ADDRESS`,`GENDER`,`EMAIL`,`IMAGE`) VALUES('NONE','NONE','user','user','1234','$DOB','NONE','NONE','NONE','NONE','NONE','***@gmail.com','../admin/user.png')";
        ...
        <div class="modal fade " id="insertModal" tabindex="-1" aria-labelledby="insertModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content text-light bg-dark">
                    ...
                    <div class="modal-body">
                        <form action="user.php" method="POST" enctype="multipart/form-data" class="container">
                            <fieldset>
                    ...
                    <div class="modal-dialog ">
                        <div class="modal-content text-light bg-dark">
                            ...
                            <?php endif ?>
                                ...
                                <form action="/WEB_SCRAPPING/php/User_Script.php" method="POST" enctype="multipart/form-data" class="container">
                                    <fieldset>
                ...
                Array.from(deletes).forEach((element) => {
                    element.addEventListener("click", (e) => {
                        ...
                        if (confirm("You want to delete this record?")) {
                            console.log("yes");
                            window.location = `/WEB_SCRAPPING/php/User_Script.php?delete=${sno}`;
                        }
