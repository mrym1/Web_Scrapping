...
<html lang="en">
  ...
  <body id="body-pd" style="background-image: url('../images/4.jpg'); background-size: cover;">
	<?php
	...
	<div class="container px-lg-4 my-1 pt-5 ">
            ...
            <div class="modal-dialog ">
                <div class="modal-content text-light bg-dark">
                    ...
                    <div class="modal-body">
                        <form action="/WEB_SCRAPPING/php/panel.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="snoEdit1" id="snoEdit1">
                            <div class="mb-3">
                                <?php echo  '<p class="card-text text-center"><img src="/WEB_SCRAPPING/admin/' . $_SESSION['IMAGE']; ?>" class="card-img p-size-admin1" alt="..."><br><strong><?php echo strtoupper($_SESSION['NAME']); ?></strong></p>
                            </div>
                            <div class="mb-3">
        ...
        <div class="d-flex justify-content-center align-items-center pt-2 pb-5 flex-wrap" data-aos="fade-right">
            <div class="card bg-dark text-white mx-2 my-3 hove w_login" style="width: 18rem;">
				...
				<?php echo  '<p class="card-text text-center"><img src="/WEB_SCRAPPING/admin/' . $_SESSION['IMAGE'] ?>" class="card-img p-size-admin" alt="..."> <strong ><br><?php echo strtoupper($_SESSION['NAME']) ?></strong></p>
					<div class="card-img-overlay card-text d-flex align-items-end justify-content-center text-center">
						<button type="button" class="btn btn-outline-dark btn-sm mx-2" data-bs-toggle="modal" data-bs-target="#updateModal">Update Account</button>
			...
			<div class="card bg-dark text-white mx-2 my-2 hove w_login" style="width: 18rem;">
					...
					<div class="card-img-overlay d-flex justify-content-end">
						<i class="las la-users la-5x card-img-top A_size text-dark"></i>
					</div>
					<div class="card-img-overlay d-flex justify-content-start F_Size counter text-dark">
						<?php
					...
					<div class="card-img-overlay card-text d-flex align-items-end justify-content-center text-center">
						<a href="/WEB_SCRAPPING/php/user.php"><button type="button" class="btn btn-outline-dark btn-sm mx-2">View User</button></a>
					</div>
				</div>
                ...
                <div class="card bg-dark text-white mx-2 my-2 hove w_login" style="width: 18rem;">
					<img src="../images/1.jpg" class="img" alt="...">
					<div class="card-img-overlay d-flex justify-content-end">
						<i class="lab la-cloudversify la-5x card-img-top A_size text-dark"></i>
					</div>
					<div class="card-img-overlay d-flex justify-content-start F_Size counter text-dark">
						<?php
					...
					<div class="card-img-overlay card-text d-flex align-items-end justify-content-center text-center">
						<a href="/WEB_SCRAPPING/php/Scrapping.php"><button type="button" class="btn btn-outline-dark btn-sm mx-2">View Data</button></a>
					</div>
				</div>
